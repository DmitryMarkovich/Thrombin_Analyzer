...
CalR6$set(
    ...
    overwrite = FALSE);  ## End of CalR6$fit_LateMM
################################################################################
...
CalR6$set(
    ...
    overwrite = FALSE);  ## End of CalR6$get_LateMM
################################################################################
...
CalR6$set(
    ...
    overwrite = FALSE);  ## End of CalR6$parms_LateMM
################################################################################
...
CalR6$set(
    ...
    overwrite = FALSE);  ## End of CalR6$_get_init_rate_LateMM
################################################################################
