...
CalR6$set(
    ...
    overwrite = FALSE);  ## End of CalR6$fit_LateExp
################################################################################
...
CalR6$set(
    ...
    overwrite = FALSE);  ## End of CalR6$get_LateExp
################################################################################
...
CalR6$set(
    ...
    overwrite = FALSE);  ## End of CalR6$get_init_rate_LateExp
################################################################################
...
CalR6$set(
    ...
    overwrite = FALSE);  ## End of CalR6$parms_LateExp
################################################################################
